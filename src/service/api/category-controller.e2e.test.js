...
const DataService = require(`./../data-service/category-data-service`);
...
categoryController(app, new DataService(mockData));
...
describe(`API returns category list`, () => {
  ...
  test(`Category names are "Кино", "Музыка", "IT", "Железо", "За жизнь", "Разное", "Без рамки", "Деревья", "Программирование"`, () =>
